    ...
    <div class="master-page-header">
        <div class="master-header-left">
            <div class="master-breadcrumb">
                ...
                <span class="master-breadcrumb-active" style="color:#EF4444;">Hapus Pelanggan</span>
            </div>
    ...
    <div class="master-delete-card">
        <div class="master-delete-header">
            <div class="master-delete-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
            </div>
            <div>
                <h2>Hapus Data Pelanggan?</h2>
                <p>Anda akan menghapus data pelanggan berikut dari sistem.</p>
            </div>
        </div>

        <div class="master-delete-detail">
            <div class="master-delete-row">
                <span class="master-delete-key">ID Pelanggan</span>
                <span class="master-delete-val"><span class="master-id-badge" style="color:#10B981;background:#F0FDF4;border-color:#BBF7D0;">{{ $pelanggan->id_pelanggan }}</span></span>
            </div>
            <div class="master-delete-row">
                <span class="master-delete-key">Nama</span>
                <span class="master-delete-val">{{ $pelanggan->nama }}</span>
            </div>
            <div class="master-delete-row">
                <span class="master-delete-key">No Telepon</span>
                <span class="master-delete-val">{{ $pelanggan->no_telpn ?: '-' }}</span>
            </div>
        </div>
